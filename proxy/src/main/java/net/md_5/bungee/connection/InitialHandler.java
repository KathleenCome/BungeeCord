...
public class InitialHandler extends PacketHandler implements PendingConnection
{
    ...
    public void handle(final EncryptionResponse encryptResponse) throws Exception
    {
        ...
        String sessionURL = BungeeCord.getInstance().config.getSessionURL();
        String authURL = sessionURL + "/session/minecraft/hasJoined?username=" + encName + "&serverId=" + encodedHash + preventProxy;
